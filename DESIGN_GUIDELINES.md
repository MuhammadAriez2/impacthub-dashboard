...
For ImpactHub specifically: the subject is a social-impact tracking tool for Malaysian SME founders with no ESG background. The audience is busy, non-technical business owners. The page's single job (for the Dashboard) is letting a founder judge "how are we doing" in 10 seconds.
...
Work in two passes. First, brainstorm a short design plan: create a compact token system with color, type, layout, and signature. Color: describe the palette as 4-6 named hex values. Type: the typefaces for 2+ roles (a characterful display face used with restraint, a complementary body face, and a utility face for captions/data if needed). Layout: a layout concept, using one-sentence prose descriptions to ideate and compare. Signature: the single unique element this page will be remembered by.

Then review that plan against the brief before building: if any part of it reads like the generic default you would produce for any similar page rather than a choice made for this specific brief, revise that part, say what you changed and why. Only after confirming the relative uniqueness of your design plan should you write the code, following the revised plan exactly.
...
Words appear in a design for one reason: to make it easier to understand and use. Bring the same intentionality to copy that you would bring to spacing and color. Before writing anything, ask what the design needs to say, and how it can best be said to help the person navigate the experience.
...
Treat failure and emptiness as moments for direction, not mood. Explain what went wrong and how to fix it, in the interface's voice rather than a person's. An empty screen is an invitation to act.
